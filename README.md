[STARWARS.py](https://github.com/user-attachments/files/27805055/STARWARS.py)
...
class RemBeautyApp(tk.Tk):
    def __init__(self):
        ...
        self.fg_color = "#3700FF" # Cinza escuro para texto (mais suave que o preto puro)
        self.accent_color = "#000000" # Lilás (Lavender) característico
        self.btn_active = "#000000" # Lilás um pouco mais escuro para o hover
    ...
    def create_widgets(self):
        ...
        title = tk.Label(header_frame, text="VENHA SER UM JEDI ☬", 
                         font=("Helvetica", 42, "bold"), bg=self.bg_color, fg=self.fg_color)
        title.pack()
        
        subtitle = tk.Label(header_frame, text="JEDI ORDEM ⚔", 
        ...
        # Texto de chamada
        lbl_call = tk.Label(main_frame, text="junte-se à nossa ordem:", 
